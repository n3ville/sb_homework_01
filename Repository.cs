...
namespace Homework_01
{
    ...
    class Repository
    {
        ...
        /// <summary>
        /// Метод, увольняющий определенное число работников
        /// </summary>
        /// <param name="Workers">Число работников, которых нужно уволить</param>
        public void DeleteWorkerByCount(int Workers)
        {
            this.Workers.RemoveRange(0, Workers);//Удаление работников, число которых удовлетворяет выбранному Workers
        }

        public void DeleteAll()
        {
            this.Workers.Clear();//Очистка БД
        }
    }
}
